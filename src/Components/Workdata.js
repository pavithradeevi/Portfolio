...
const ProjectcardData=[
    {
        imgsrc:"https://cdn.dribbble.com/users/882190/screenshots/17049267/ios-mobile-app-design-flight-app.png?resize=400x0",
        title:"CrewApp - [Current Project]",
        software:"React Native,SQL,Push-Notification,Calander",
        text:"Developing a mobile app for pilots that uses React Native and SQL to include features like alarms, daily flight information, personal monthly reports, leave applications, notifications of flight updates, and more. It is also functional in offline mode.",
